...
| :--- | :--- | :--- |
| **João Guilherme Possati** | Gestão de Usuários (Módulo Administrador) | [@Possati](https://github.com/Possati) |
| **Helio Dias** | Gestão de Seleções e Jogadores | [@HelioDias](https://github.com/HelioDias) |
| **Giovanna Sperandio** | Gestão de Estádios e Árbitros | [@gSperandio](https://github.com/gSperandio) |
| **Leonardo Aoki** | Gestão e Calendário de Partidas | [@LeonardoAoki](https://github.com/LeonardoAoki) |
